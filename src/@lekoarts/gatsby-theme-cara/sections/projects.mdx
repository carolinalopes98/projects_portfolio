...
<ProjectCard
  title="MyDeej"
  link="https://github.com/carolinalopes98/MyDeej"
  bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
>
  <div style={{ marginBottom: '1rem', color: 'white' }}>
    An open-source physical volume controller. Constructed using a Seeduino, custom circuitry, and a 3D-printed enclosure for tactile system audio management.
  </div>
  
  <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
    <span style={{ background: 'rgba(0,0,0,0.2)', padding: '4px 8px', borderRadius: '4px', fontSize: '0.8rem', color: 'white', fontWeight: 'bold' }}>
      Python
    </span>
    <span style={{ background: 'rgba(0,0,0,0.2)', padding: '4px 8px', borderRadius: '4px', fontSize: '0.8rem', color: 'white', fontWeight: 'bold' }}>
      Arduino
